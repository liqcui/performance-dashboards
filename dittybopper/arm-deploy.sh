...
export REPOSITORY="https://github.com/liqcui/performance-dashboards.git" # Repo to pull dashboards templates
...
# Other vars
deploy_template="templates/arm-dittybopper.yaml.template"
